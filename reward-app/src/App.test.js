import { calculatePoints, calculateMonthlyPoints } from "./utils/rewardCalculator";
...
describe('calculateMonthlyPoints', () => {
  ...
  test('should handle transactions in the same month with different amounts for the same customer', () => {
    ...
    expect(calculateMonthlyPoints(transactionsSameMonth)).toEqual(expectedPoints);
  });
  ...
  test('should handle different customers and different months correctly', () => {
    ...
    expect(calculateMonthlyPoints(transactionsDifferentCustomers)).toEqual(expectedPoints);
  });
